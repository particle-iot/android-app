...
public class TinkerFragment extends BaseFragment implements OnClickListener {
    ...
    List<Pin>        aPins            = list();
    List<Pin>        dPins            = list();
    List<Pin>        allPins          = list();
    List<Pin>        digitalReadPins  = list();
    List<Pin>        digitalWritePins = list();
    List<Pin>        analogWritePins  = list();
    List<Pin>        analogReadPins   = list();
    Map<String, Pin> pinsByName       = map();
