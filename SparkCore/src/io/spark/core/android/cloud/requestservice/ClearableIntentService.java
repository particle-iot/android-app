...
/**
 * This is just a subclass of IntentService which can have its queue cleared
 ...
 */
public abstract class ClearableIntentService extends Service {


	public static final String ACTION_CLEAR_INTENT_QUEUE = "ACTION_CLEAR_INTENT_QUEUE";
	 ...
	 */
	public ClearableIntentService(String name) {
		super();
		mName = name;
	}
	...
	public void onStart(Intent intent, int startId) {
		if (intent.getAction().equals(ACTION_CLEAR_INTENT_QUEUE)) {
